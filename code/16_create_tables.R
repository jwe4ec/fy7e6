...
create_full_tbl_a1 <- function(results, out_path) {
  ...
  pooled_conv_stats <- pooled_conv_stats[, c("num_converge_all", "mean", "emp_sd",
  ...
  write.csv(pooled_conv_stats, paste0(out_path, model_name, ".csv"))
...
lapply(res_drp_c1_2000bs, create_full_tbl_a1, full_results_tbl_path)
lapply(res_eff_c1_2000bs, create_full_tbl_a1, full_results_tbl_path)

# ---------------------------------------------------------------------------- #
# TODO: Create full tables for "a2" models ----
# ---------------------------------------------------------------------------- #

# Define function to create tables with full results for "a2" models

create_full_tbl_a2 <- function(results, out_path) {
  ...
  stats <- stats[, c("mean", "emp_sd", "hpd_ci", "geweke_z", "sig")]
  ...
  write.csv(stats, paste0(out_path, model_name, ".csv"))
...
lapply(res_drp_c2_4_1000000iter, create_full_tbl_a2, full_results_tbl_path)
lapply(res_eff_c2_4_1000000iter, create_full_tbl_a2, full_results_tbl_path)
