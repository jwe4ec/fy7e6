...
Scripts 13a-13d were used to run the "a1" analysis models in parallel on the Standard partition using 2,000 bootstrap samples with 20,000 iterations.
